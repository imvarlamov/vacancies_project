...
jobs = [
    ...
    {"id": "1", "title": "Разработчик на Python", "specialty": "backend", "company": "3", "salary_from": "100000",
     ...
     "description": "<p>Офис в центре города с террасой и кальяном, чай, плюшки и виски всегда в наличии. "
                    ...
                    "<li>Опыт работы с Docker</li> <li>Навык написания сервисов на Asyncio</li>"
                    " <li>Навык использования командной строки Linux/UNIX</li> <li>Умение работать с Git</li> "
                    "</ul> <p>Зарплата достойная, обсуждается персонально с учетом пожеланий на собеседовании,"
    ...
    {"id": "2", "title": "Разработчик в проект на Django", "specialty": "backend", "company": "6",
     ...
     "description": "<p>Мы работаем на рынке веб-разработки уже более 10 лет. Основное направление - заказная"
                    ...
                    " отвлекают от работы</li> <li>вы жаворонок, потому что знаете, что утром голова работает лучше и "
                    "задачи решаются быстрее</li> <li>вы уже знаете, что идеальных ТЗ не бывает</li> <li>вы понимаете,"
                    " что прежде чем отдать задачу на проверку тестировщику надо самим все хорошо проверить. А если у "
                    "проекта нет тестировщика (что периодически бывает), то проверить все дважды.</li> "
                    ...
                    " <li>вы самостоятельный и ответственный, умеете здраво оценивать свои силы</li> "
                    "</ul> <p><b>Как у нас все устроено:</b></p> <ul> <li>в качестве мессенджера Slack</li> "
                    "<li>ведение задач в Gitlab</li> <li>таймтрекинг в Toggl</li> <li>проекты завернуты в Docker</li>"
                    " <li>CI/CD настроен</li> <li>Тесты пишем редко (только ключевой функционал покрываем при"
                    " необходимости)</li></ul> <p><b>Что предлагаем:</b></p> <ul> <li>Стабильную удаленную работу</li> "
                    "<li>Проектную работу/Официальное трудоустройство</li> <li>Почасовую оплату/Оплату за месяц</li>"
                    " <li>Обсуждаемое количество рабочих часов в месяц (100-200)</li> <li>Регулярные выплаты (2 раза в"
                    " месяц)</li> <li>Лояльный рабочий график, начало рабочего дня не позже 10 по мск</li> "
